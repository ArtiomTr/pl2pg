...
public class SymbolTable {
    ...
    public Type lookupType(String name) {
        return innerLookupType(name.toUpperCase());
    }

    private Type innerLookupType(String name) {
        if (this.typeReferenceMap.containsKey(name)) {
            return this.typeReferenceMap.get(name);
        }

        if (parent != null) {
            return parent.innerLookupType(name);
        }
    ...
    public void addType(String name, Type type) {
        this.typeReferenceMap.put(name, type);
    }
